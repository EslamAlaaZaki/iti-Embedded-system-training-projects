#line 1 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
#line 1 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
#line 1 "c:/users/as/documents/mikroelektronika/mikroc pro for arm/include/stdint.h"
...
#line 1 "c:/users/as/documents/mikroelektronika/mikroc pro for arm/include/stddef.h"
...
#line 1 "c:/users/as/documents/mikroelektronika/mikroc pro for arm/include/string.h"
...
#line 1 "c:/users/as/documents/mikroelektronika/mikroc pro for arm/include/stdbool.h"



 typedef char _Bool;
#line 23 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
typedef void ( *at_cmd_cb )( char *buffer );
#line 28 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
typedef void ( *at_write_p )( unsigned int in );
#line 40 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
typedef enum
{
#line 44 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 AT_CMD_UNKNOWN = 0,
#line 47 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 AT_CMD_GET = 1,
#line 50 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 AT_CMD_SET = 2,
#line 53 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 AT_CMD_TEST = 3,
#line 56 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 AT_CMD_EXEC = 4,

}at_type_t;
#line 68 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
typedef struct
{
#line 72 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 uint32_t hash;
#line 75 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 uint32_t timeout;
#line 78 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 at_cmd_cb getter;
#line 81 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 at_cmd_cb setter;
#line 84 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 at_cmd_cb tester;
#line 87 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
 at_cmd_cb executer;

}at_cmd_t;
#line 107 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
void at_init( at_cmd_cb default_callback, at_write_p default_write,
 uint8_t *buffer_ptr, uint16_t buffer_size );
#line 119 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
void at_rx( char rx_input );
#line 127 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
void at_tick( void );
#line 137 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
void at_cmd_single( char *cmd );
#line 149 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
void at_cmd_double( char *cmd, char *arg_1 );
#line 162 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
void at_cmd_triple( char *cmd, char *arg_1, char *arg_2 );
#line 178 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
void at_cmd_save( char *cmd, uint32_t timeout,
 at_cmd_cb getter, at_cmd_cb setter,
 at_cmd_cb tester, at_cmd_cb executer );
#line 187 "c:/users/as/desktop/gsm_stud_lib_to_edit/at_engine.h"
void at_process( void );
#line 84 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
typedef enum
{
 AT_OK,
 AT_ERROR,
...
#line 103 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
extern sfr sbit CTS_PIN;
extern sfr sbit RTS_PIN;
#line 111 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
static void ( *write_uart_p ) ( unsigned int data_out );
#line 119 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
...
static at_cmd_t at_cmd_storage [  5  ];
...
#line 170 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
static void _tx( uint8_t *tx_input, uint8_t delimiter );
#line 181 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
static uint32_t _parse_hash( char *cmd );
#line 192 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
static uint16_t _parse_find( char* cmd );
#line 208 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
static void _parse_save( char *command, uint32_t timeout,
 at_cmd_cb getter, at_cmd_cb setter,
 at_cmd_cb tester, at_cmd_cb executer );
#line 226 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
static at_type_t _parse_pre( char *raw_in, char *clean_out );
#line 239 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
static void _parse_exe( char *input, at_cmd_cb *cb, uint32_t *timeout );
#line 243 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
static void _tx( uint8_t *tx_input, uint8_t delimiter )
{
#line 248 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
 while( *tx_input )
 {
#line 257 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
 write_uart_p( *tx_input++ );
 }

 write_uart_p( delimiter );
 write_uart_p( '\n' );
#line 266 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
}
...
#line 343 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
...
#line 431 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
void at_init
(
...
)
{
 ...
 write_uart_p = default_write;
  ...
  { at_cmd_storage_used = 0; for( tmp_cnt = 0; tmp_cnt < 5 ; tmp_cnt++ ) { at_cmd_storage[ tmp_cnt ].hash = 0; at_cmd_storage[ tmp_cnt ].timeout = 0; at_cmd_storage[ tmp_cnt ].getter = ((void *)0) ; at_cmd_storage[ tmp_cnt ].setter = ((void *)0) ; at_cmd_storage[ tmp_cnt ].tester = ((void *)0) ; at_cmd_storage[ tmp_cnt ].executer = ((void *)0) ; }} ;
...
void at_process( void )
{
#line 555 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
 if( response_f )
 {
#line 562 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
  { t_char_f = 0 ; } ;
  { t_response_f = 0 ; } ;
 ...
 if( no_response_f )
 {
#line 577 "C:/Users/as/Desktop/GSM_STUD_LIB_To_Edit/at_engine.c"
  { t_char_f = 0 ; } ;
  { t_response_f = 0 ; } ;
 _parse_exe( p_rx_buf, &cb, &tmp_timer );
 cb( p_rx_buf );
